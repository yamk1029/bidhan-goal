            ...
            <div class="col-md-8">
                ...
                <form method="POST" action="db/update-goal.php">
                    <div class="md-3">
                        ...
                        <input value="<?php echo $post['title']; ?>" placeholder="Title" type="text" style=""
                    ...
                    <div class="md-3">
                        ...
                        <textarea id="news" placeholder="Type some texts..." type="text" class="form-control"
                            name="description"><?php echo $post['descriptions']; ?></textarea>
                    </div>
                    ...
                    <div class="md-3">
                        ...
                        <input name="date" value="<?php echo $post['accomplish_date']; ?>" type="date" style=""
                            class="form-control ">
                    </div>
